...
<form method ="POST" action="/dashboard/produk/{{$products->id}}/edit">
    ...
    <br>
    <input type="text" id="nama" name="nama" placeholder="Nama Produk" style="width:80%;" value="{{$products->nama}}">
    ...
    <br>
    <input type="text" id="harga" name="harga" placeholder="Nama Produk" style="width:80%;" value="{{$products->harga}}"> 
    ...
    <br>
    <input type="text" id="foto" name="foto" placeholder="Link gambar" style="width:80%;" value="{{$products->foto}}">
