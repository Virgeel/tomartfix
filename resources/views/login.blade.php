...
<body class="grid-container-login" style="margin: 0;">
    <div class="loginbg item1login">
        <div style="padding-top:300px;padding-left:200px;">
            ...
            <img src="{{asset('images/comma.png')}}" width="105" height="74">
            <div
                style="border-radius:10px;background: rgba(255,255,255,0.6);background-size:200px;width : 600px;heigth : 5000px;font-size:32px;padding:40px;font-weight:semi-bold">
        ...
        <div style="font-family:Poppins;padding-top:20px;">
            <form action="/login" method="post">
                ...
                <div class="input-box">
                    ...
                    <iconify-icon icon="ic:outline-email" height="30"
                        style="color:gray;padding:10px;position: absolute;"></iconify-icon>
                    <input type="email" class="input-field" id="email" name="email" placeholder="Masukkan email"
                ...
                <p>
                    ...
                    <br>
                    <div class="input-box">
                        <iconify-icon icon="mdi:lock" height="30" style="color:gray;padding:10px;position:absolute;">
                        </iconify-icon>
